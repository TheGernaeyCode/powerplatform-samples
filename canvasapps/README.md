...
For more info about how to use the Power Apps - Canvas App Samples, <strong>please read the README.md file in every sample directory and look in the assets folders for documentation covering the sample</strong>
